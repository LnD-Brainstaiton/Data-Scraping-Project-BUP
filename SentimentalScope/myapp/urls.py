...
from .views import (
    ...
    api_analyze_sentiment, api_generate_summary
)
...
urlpatterns = [
    ...
    # AI API endpoints
    path('api/analyze-sentiment/', api_analyze_sentiment, name='api_analyze_sentiment'),
    path('api/generate-summary/', api_generate_summary, name='api_generate_summary'),
]